...
@Component
public class JWT {
    @Value("${spring.jwt.secret}") // Il segreto sarà salvato in env.properties e letto da application.properties
    ...
    public String createToken(User user) {
        ...
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + 1000 * 60 * 10)) // Data di scadenza del Token (Expiration Date), anche questa in millisecondi
